...
VALUES
(1, 0, '', 0, '', 'platform', 'rootAgent', '平台总代理', '$2a$10$abcdefghijklmnopqrstuv', 'admin@jh.com', '13800000001', '/avatars/admin.png', '127.0.0.1', NOW(), '88888888', 1, ''),
(2, 1, 'rootAgent', 2, 'agent1', 'agent', 'agent1', '代理1', '$2a$10$mnopqrstuvwxyzabcdefghi', 'agent1@jh.com', '13800000002', '/avatars/agent.png', '192.168.0.10', NOW(), '88000001', 1, ''),
(3, 2, 'agent1', 2, 'agent1', 'seller', 'seller1', '卖家1', '$2a$10$uvwxyzabcdefghijklmno', 'seller1@jh.com', '13800000003', '/avatars/seller.png', '192.168.0.11', NOW(), '66000001', 1, ''),
(4, 3, 'seller1', 2, 'agent1', 'seller', 'seller2', '卖家2', '$2a$10$uvwxyzabcdefghijklmno', 'seller2@jh.com', '13800000004', '/avatars/seller.png', '192.168.0.11', NOW(), '66000002', 1, ''),
(5, 3, 'seller1', 0, '', 'buyer', 'buyer1', '买家1', '$2a$10$abcdef1234567890ghijk', 'buyer1@jh.com', '13800000005', '/avatars/buyer.png', '10.0.0.1', NOW(), NULL, 1, ''),
(6, 0, '', 0, '', 'autoBuyer', 'autoBuyer1', '自动化买家1', '$2a$10$abcdef1234567890ghijk', 'autobuyer@jh.com', '13800000006', '/avatars/buyer.png', '10.0.0.1', NOW(), NULL, 1, '');
